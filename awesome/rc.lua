...
local function set_wallpaper(s)
    ...
    if beautiful.wallpaper then
        ...
        gears.wallpaper.maximized("$HOME/wallpapers/shuffle/lofijapancafe.jpg", s)
end
...
awful.screen.connect_for_each_screen(function(s)
    -- Wallpaper
    set_wallpaper("$HOME/wallpapers/shuffle/lofijapancafe.jpg")
...
awful.spawn.with_shell("nitrogen --random --save --set-zoom-fill ~/wallpapers/treasure")
    -- Create the wibox
    s.mywibox = awful.wibar({ position = "bottom", screen = s, bg = "#000000cf", fg = "#909090" })
